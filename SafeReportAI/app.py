...
if page == "About the Model":
    ...
    <div class='metric-card'>
        ...
        LR was selected based on higher AUC-ROC (0.7163 vs 0.7081), meaning it
        discriminates better overall. However, Random Forest has a much higher Recall
        (85.16% vs 65.91%) — it catches far more urgent incidents at the cost of more
    ...
    if st.button("CLASSIFY INCIDENT REPORT"):
        if not any([desc, what_happened, illness, before, obj_substance, location]):
            ...
            if prediction == 1:
                ...
                escalation.<br><br>
                The model is correct on Low Priority cases approximately <b>64.0%</b> of the
